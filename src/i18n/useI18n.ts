...
const STRINGS = {
  'pt-BR': {
    ...
    settings: {
      ...
      language: 'Idioma',
      languageHelp: 'Troca os textos do app entre portugues e ingles (cobertura em evolucao).',
  ...
  en: {
    ...
    settings: {
      ...
      language: 'Language',
      languageHelp: 'Switch app text between Portuguese and English (coverage is being expanded).',
